...
{
    internal sealed class AggregateTradeWebSocketClientAdapter : WebSocketClientAdapter<IAggregateTradeWebSocketClient>, IAggregateTradeWebSocketClient
    {
        ...
        public AggregateTradeWebSocketClientAdapter(IBinanceWebSocketClientManager manager, IAggregateTradeWebSocketClient client, ILogger<IBinanceWebSocketClientManager> logger = null, Action<Exception> onError = null)
